...
set CFLAGS=/nologo /c /Od /Zi /MT /D_CRT_SECURE_NO_DEPRECATE /DPLATFORM_DESKTOP /DMPACK_EXTENSIONS=1 /DMPACK_DEBUG=1
...
link /nologo ^
  ...
  ..\dyibicc\unicode.obj ^
  ..\dyibicc\util.obj ^
  winmm.lib user32.lib gdi32.lib shell32.lib onecore.lib /out:rdy.exe
